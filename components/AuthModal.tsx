...
import { signInWithGoogle, signInWithGitHub, signInWithMagicLink, checkAuthRateLimit } from '@/lib/auth'
...
export default function AuthModal({ onClose, onSuccess }: AuthModalProps) {
  ...
  const handleGoogleSignIn = async () => {
    if (!checkAuthRateLimit('google-signin', 3, 60000)) {
  ...
  const handleGitHubSignIn = async () => {
    if (!checkAuthRateLimit('github-signin', 3, 60000)) {
      setError('Too many attempts. Please wait a minute.')
      return
    }
  ...
  const handleMagicLinkSignIn = async (e: React.FormEvent) => {
    ...
    if (!checkAuthRateLimit(`magic-link-${email}`, 2, 120000)) {
        ...
        <div className="auth-modal-content">
          ...
          {magicLinkSent ? (
            <div className="auth-success" role="status">
              ...
              <p className="auth-hint">Click the link in your email to sign in securely.</p>
              <button 
            ...
            <>
              ...
              <div className="auth-oauth-buttons">
                ...
                <button
                  ...
                  disabled={loading}
                >
                  <svg className="auth-button-icon" viewBox="0 0 24 24" fill="currentColor">
